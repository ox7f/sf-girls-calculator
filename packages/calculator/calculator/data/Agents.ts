import { NewAgent, NewDamageEffect, NewDOTEffect, NewEffect, NewSkill, NewStats } from '../model/index';
import { ClassEnum, CupSizeEnum, EffectTypeEnum, OrganizationEnum } from '../enums/index';
import { EffectParamType } from '../model/types/index';
...
export const Yuki = {
  ...
  skill: {
    ...
    effects: [
      {
        type: EffectTypeEnum.Self,
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 2.2;
          agent.stats.normal_attack *= 15;
          agent.stats.skill_damage *= 15;
        },
...
export const Neve = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 26428 } as NewDamageEffect],
    cooldown: 17
  } as NewSkill
} as NewAgent;
...
export const Ayu = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 45536 } as NewDamageEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Mika = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 11422 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 11422 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 11422 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 11422 } as NewDamageEffect
    ],
...
export const Sora = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 27891 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 27891 } as NewDamageEffect
    ],
    cooldown: 8
  } as NewSkill
...
export const Ember = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 13991 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 13991 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 13991 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 13991 } as NewDamageEffect
    ],
...
export const Chiharu = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 65165 } as NewDamageEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Irina = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 14230 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 14230 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 14230 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 14230 } as NewDamageEffect
    ],
...
export const Yuuha = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 26563 } as NewDamageEffect],
    cooldown: 16
  } as NewSkill
} as NewAgent;
...
export const Uzu = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 57490 } as NewDamageEffect],
    cooldown: 16
  } as NewSkill
} as NewAgent;
...
export const Denka = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 1, interval: 0.3, damage: () => 24892 } as NewDOTEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Reika = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 1, interval: 1, damage: () => 86932 } as NewDamageEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Noa = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 6, interval: 0.24, damage: () => 50922 / 25 } as NewDamageEffect],
    cooldown: 15
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        damage: (params: EffectParamType) => {
          ...
          let damage = agent.stats.base_skill_damage * target.current_health * 0.0002;

          if (damage < agent.stats.base_skill_damage) {
            damage = agent.stats.skill_damage;
          }
...
export const Larisa = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 69856 } as NewDamageEffect],
    cooldown: 11
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack += 16382.8;
          agent.stats.skill_damage += 16382.8;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack -= 16382.8;
...
export const Kotora = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 16404 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 16404 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 16404 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 16404 } as NewDamageEffect
    ],
...
export const Aoi = {
  ...
  skill: {
    ...
    effects: [
      {
        type: EffectTypeEnum.Team,
        apply: (params: EffectParamType) => {
          const { team } = params;
          team.forEach((agent) => (agent.stats.critical_rate += 0.25));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team.forEach((agent) => (agent.stats.critical_rate -= 0.25));
...
export const Sara = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 56213 } as NewDamageEffect],
    cooldown: 11
  } as NewSkill
} as NewAgent;
...
export const Mai = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 85121 } as NewDamageEffect],
    cooldown: 13
  } as NewSkill
} as NewAgent;
...
export const Tsukiko = {
  ...
  skill: {
    ...
    effects: [
      ...
      { type: EffectTypeEnum.DOT, duration: 4, interval: 1 / 4, damage: () => 1450 } as NewDamageEffect
    ],
    cooldown: 38
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            ...
            .forEach((agent) => {
              agent.stats.normal_attack *= 1.5;
              agent.stats.skill_damage *= 1.5;
            });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team.forEach((agent) => {
            agent.stats.normal_attack *= 4.33;
            agent.stats.skill_damage *= 4.33;
          });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Gunner)
            .forEach((agent) => {
              agent.stats.critical_rate += 0.2;
              agent.stats.critical_damage += 1.2;
            });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { team } = params;
          team.forEach((agent) => (agent.stats.attack_speed *= 2.2));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team.forEach((agent) => (agent.stats.attack_speed /= 2.2));
...
export const Cadence = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 0.8, interval: 0.1, damage: () => 8603 } as NewDamageEffect],
    cooldown: 10
  } as NewSkill
} as NewAgent;
...
export const Uni = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 86411 } as NewDamageEffect],
    cooldown: 20
  } as NewSkill
} as NewAgent;
...
export const Sizuko = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 4 * 35211 } as NewDamageEffect], // 126,980
    cooldown: 18
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 7.15;
          agent.stats.normal_attack *= 1.14;
          agent.stats.skill_damage *= 1.14;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 7.15;
...
export const Mei = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 0.4, interval: 0.1, damage: () => 24463 } as NewDamageEffect],
    cooldown: 12
  } as NewSkill
} as NewAgent;
...
export const Riho = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 2, interval: 1 / 4, damage: () => 9541 } as NewDamageEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Mitsu = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 2, interval: 1 / 8, damage: () => 4873 } as NewDamageEffect],
    cooldown: 14
  } as NewSkill
} as NewAgent;
...
export const Akina = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 80727 } as NewDamageEffect,
      { type: EffectTypeEnum.DOT, duration: 5, interval: 1, damage: () => 1903 } as NewDOTEffect
    ],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Akari = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 1, interval: 1 / 8, damage: () => 6776 } as NewDOTEffect],
    cooldown: 7
  } as NewSkill
} as NewAgent;
...
export const Sayaka = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 30682 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 30682 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 30682 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 30682 } as NewDamageEffect
    ],
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 5.3;
          agent.attack_mode = 'None';
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 5.3;
          agent.attack_mode = 'Normal';
        },
        duration: 4
      } as NewEffect,
      // TODO:
      { type: EffectTypeEnum.DOT, duration: 4, interval: 0.04, damage: () => 432 } as NewDOTEffect
    ],
    cooldown: 15
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 4.6;
          agent.stats.skill_damage *= 4.6;
          agent.stats.critical_rate *= 11.6;
          agent.stats.projectile_number = 2;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 4.6;
          agent.stats.skill_damage /= 4.6;
          agent.stats.critical_rate /= 11.6;
          agent.stats.projectile_number = 1;
        },
        duration: 12
      } as NewEffect
    ],
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            ...
            .forEach((agent) => (agent.stats.critical_damage += 1.9));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team
      ...
      { type: EffectTypeEnum.DOT, duration: 3, interval: 1 / 8, damage: () => 691 } as NewDOTEffect
    ],
    is_stackable: true,
    cooldown: 20
  } as NewSkill
...
export const Eiko = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 1.5, interval: 1 / 8, damage: () => 2898 } as NewDOTEffect],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Goi = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 25098 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 25098 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 25098 } as NewDamageEffect
    ],
    cooldown: 10
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          agent.stats.attack_speed *= 2.76;
          agent.stats.normal_attack *= 1.89;
          agent.stats.skill_damage *= 1.89;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 2.76;
      ...
      { type: EffectTypeEnum.DOT, duration: 2, interval: 1 / 8, damage: () => 315 } as NewDOTEffect
    ],
    cooldown: 14
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 10;
          agent.stats.skill_damage *= 10;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 10;
      ...
      { type: EffectTypeEnum.DOT, duration: 7, interval: 1, damage: () => 3310 } as NewDOTEffect
    ],
    cooldown: 9
  } as NewSkill
} as NewAgent;
...
export const Hami = {
  ...
  skill: {
    ...
    effects: [
      { type: EffectTypeEnum.Damage, damage: () => 55912 } as NewDamageEffect,
      { type: EffectTypeEnum.Damage, damage: () => 55912 } as NewDamageEffect
    ],
    cooldown: 8
  } as NewSkill
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.critical_rate += 0.16;
          agent.stats.critical_damage += 0.64;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.critical_rate -= 0.16;
      ...
      { type: EffectTypeEnum.DOT, duration: 1, interval: 1 / 8, damage: () => 9971 } as NewDamageEffect
    ],
    cooldown: 11
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 10.35;
          agent.stats.projectile_number = 5;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 10.35;
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Striker)
            .forEach((agent) => (agent.stats.critical_rate += 0.3));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team
    ...
    effects: [
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Gunner)
            .forEach((agent) => (agent.stats.normal_attack *= 1.33));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          agent.stats.normal_attack *= 1 + non_support_num * 0.34;
          agent.stats.skill_damage *= 1 + non_support_num * 0.34;
        },
        remove: (params: EffectParamType) => {
          const { agent, team } = params;
          const non_support_num = team.filter((agent) => agent.class !== ClassEnum.Support).length;
      ...
      { type: EffectTypeEnum.DOT, duration: 1, interval: 1 / 4, damage: () => 4724 } as NewDamageEffect
    ],
    cooldown: 14
  } as NewSkill
} as NewAgent;
...
export const Chia = {
  ...
  cup_size: CupSizeEnum.H, // healthy?
  class: ClassEnum.Gunner,
  stats: {
    attack_speed: 1,
    normal_attack: 2236,
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Skill';
          agent.stats.normal_attack *= 7.5;
          agent.stats.skill_damage *= 7.5;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Normal';
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Gunner)
            .forEach((agent) => {
              agent.stats.attack_speed *= 1.3;
              agent.stats.normal_attack *= 1.7;
              agent.stats.skill_damage *= 1.7;
            });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 4.5;
          agent.stats.normal_attack *= 2.3;
          agent.stats.skill_damage *= 2.3;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 4.5;
...
export const Kaja = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 0.48, interval: 0.03, damage: () => 14613 } as NewDOTEffect],
    cooldown: 15
  } as NewSkill
} as NewAgent;
...
export const Bia = {
  ...
  skill: {
    ...
    effects: [
      ...
      { type: EffectTypeEnum.DOT, duration: 6, interval: 1 / 8, damage: () => 155.2 } as NewDOTEffect
    ],
    cooldown: 10
  } as NewSkill
} as NewAgent;
...
export const Eri = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 9 * 10298 } as NewDamageEffect],
    cooldown: 14
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 5.8;
          agent.stats.critical_rate *= 2.1;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 5.8;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 6.35;
          agent.stats.normal_attack *= 2.6;
          agent.stats.skill_damage *= 2.6;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 6.35;
      ...
      { type: EffectTypeEnum.DOT, duration: 4, interval: 1, damage: () => 4537 } as NewDOTEffect
    ],
    cooldown: 15
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Skill';
          agent.stats.attack_speed *= 2;
          agent.stats.normal_attack *= 3.8;
          agent.stats.skill_damage *= 3.8;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Normal';
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { team } = params;
          team.filter((agent) => agent.cup_size <= CupSizeEnum.D).forEach((agent) => (agent.stats.skill_damage *= 1.2));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team.filter((agent) => agent.cup_size <= CupSizeEnum.D).forEach((agent) => (agent.stats.skill_damage /= 1.2));
      ...
      { type: EffectTypeEnum.Damage, damage: () => 16 * 6120 } as NewDamageEffect
    ],
    cooldown: 10
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          zeth_member.forEach((agent) => {
            agent.stats.normal_attack *= 1 + 0.33 * zeth_member_num;
            agent.stats.skill_damage *= 1 + 0.33 * zeth_member_num;
          });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
      ...
      { type: EffectTypeEnum.DOT, duration: 3, interval: 1, damage: () => 3 * 18877.5 } as NewDamageEffect
    ],
    cooldown: 12
  } as NewSkill
} as NewAgent;
...
export const Victoria = {
  ...
  skill: {
    ...
    effects: [
      ...
      { type: EffectTypeEnum.DOT, duration: 16, interval: 0.38, damage: () => 2451.3 } as NewDOTEffect
    ],
    is_stackable: true,
    cooldown: 10
  } as NewSkill
...
export const Kura = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.DOT, duration: 8, interval: 1, damage: () => 25190 / 8 } as NewDOTEffect],
    cooldown: 3
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          agent.attack_mode = 'Skill';
          agent.stats.attack_speed *= 2;
          agent.stats.normal_attack *= 9;
          agent.stats.skill_damage *= 9;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Normal';
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Skill';
          agent.stats.attack_speed *= 5;
          agent.stats.critical_damage *= 10;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Normal';
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 2;
          agent.stats.normal_attack *= 5;
          agent.stats.skill_damage *= 5;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 2;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            ...
            .forEach((agent) => {
              agent.stats.normal_attack += Sera.stats.skill_damage * 0.25;
              agent.stats.skill_damage += Sera.stats.skill_damage * 0.25;
            });
        },
        remove: (params: EffectParamType) => {
          const { agent: Sera, team } = params;
    ...
    effects: [
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Artillery)
            .forEach((agent) => (agent.stats.critical_rate += 0.4));
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
          team
...
export const Rei = {
  ...
  skill: {
    ...
    effects: [{ type: EffectTypeEnum.Damage, damage: () => 25374 } as NewDamageEffect],
    cooldown: 10
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 2;
          agent.stats.critical_rate += 0.37;
          agent.stats.normal_attack *= 2.62;
          agent.stats.skill_damage *= 2.62;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 2;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'None';
          agent.stats.normal_attack *= 8.6;
          agent.stats.skill_damage *= 8.6;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.attack_mode = 'Normal';
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Artillery)
            .forEach((agent) => {
              agent.stats.critical_rate += 0.3;
              agent.stats.critical_damage += 0.3;
            });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
      ...
      { type: EffectTypeEnum.DOT, duration: 9, interval: 1 / 8, damage: () => 524.7 } as NewDOTEffect // TODO: 10 seconds but 1 sec animation
    ],
    cooldown: 15
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 4;
          agent.stats.normal_attack *= 1.21;
          agent.stats.skill_damage *= 1.21;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 4;
  ...
  skill: {
    ...
    effects: [
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 42;
          agent.stats.skill_damage *= 42;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 42;
      ...
      { type: EffectTypeEnum.DOT, duration: 20, interval: 1 / 2, damage: () => 1.5 } as NewDOTEffect,
      { type: EffectTypeEnum.DOT, duration: 20, interval: 1, damage: () => 86.5 } as NewDOTEffect
      // { type: EffectTypeEnum.DOT, duration: 7, interval: 1 / 4, damage: () => 909 } as NewDOTEffect
    ],
    cooldown: 20
  } as NewSkill
} as NewAgent;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 18;
          agent.stats.skill_damage *= 18;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 18;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack *= 2;
          agent.stats.skill_damage *= 2;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.normal_attack /= 2;
      ...
      } as NewEffect,
      {
        ...
        apply: (params: EffectParamType) => {
          ...
          team
            .filter((agent) => agent.class === ClassEnum.Artillery)
            .forEach((agent) => {
              agent.stats.normal_attack *= 1.1;
              agent.stats.skill_damage *= 1.1;
            });
        },
        remove: (params: EffectParamType) => {
          const { team } = params;
    ...
    effects: [
      {
        ...
        apply: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed *= 2.4;
          agent.stats.normal_attack *= 5.3;
          agent.stats.skill_damage *= 5.3;
        },
        remove: (params: EffectParamType) => {
          const { agent } = params;
          agent.stats.attack_speed /= 2.4;
      ...
      { type: EffectTypeEnum.DOT, duration: 1, interval: 1 / 8, damage: () => 263.5 } as NewDOTEffect
    ],
    cooldown: 16
  } as NewSkill
} as NewAgent;
...
export const Seina = {
  ...
  skill: {
    ...
    effects: [
      ...
      { type: EffectTypeEnum.Damage, damage: () => 4 * 7294 } as NewDamageEffect,
      { type: EffectTypeEnum.DOT, duration: 6, interval: 1, damage: () => 29178 / 6 } as NewDOTEffect
    ],
    cooldown: 12
  } as NewSkill
} as NewAgent;
